...
export class PluckSynth {
  ...
  constructor() {
    ...
    this.synth.chain(this.filter, this.pingPong, this.reverb, this.gain, Tone.Destination);
  ...
  playNote(note: Tone.Unit.Frequency, duration: Tone.Unit.Time, time?: Tone.Unit.Time): void {
