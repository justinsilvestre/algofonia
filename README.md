...
2. Navigate to the app (don't forget the S in "https"!)
   - [https://localhost:3000/listen](https://localhost:3000/listen) for the _output client_
   - [https://<your-ip-here>:3000](https://<your-ip-here>:3000) for the _input client_. You should see the exact address in your terminal output after step 1.
...
- https://<some>-<random>-<words>-<here>.trycloudflare.com/listen for the _output client_
- https://<some>-<random>-<words>-<here>.trycloudflare.com for the _input client_
